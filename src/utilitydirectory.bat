...
@java -cp %TRANSFORM_HOME%\transformenator.jar org.transformenator.UtilityDirectory "%1" "%2" "%3" "%4"
@goto end

:nosuffix
@java -cp %TRANSFORM_HOME%\transformenator.jar org.transformenator.UtilityDirectory "%1" "%2" "%3"
@goto end

:usage
@java -cp %TRANSFORM_HOME%\transformenator.jar org.transformenator.UtilityDirectory
