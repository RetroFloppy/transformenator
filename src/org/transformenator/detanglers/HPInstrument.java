    ...
    // It's a bigger (i.e. Bernoulli) image
    {
      ...
      for (int i = 0xa10000; i < 0xa30000; i += 0x20)
      {
        ...
        if (UnsignedByte.intValue(inData[i]) != 0x00) // Anything but null
        {
          ...
          {
            case 0x02:
              fileTypeString = "source";
              break;
            case 0x03:
              fileTypeString = "reloc";
              break;
            case 0x04:
              fileTypeString = "listing";
              break;
            case 0x05:
              fileTypeString = "link_sym";
              break;
            case 0x06:
              fileTypeString = "emul_com";
              break;
            case 0x07:
              fileTypeString = "link_com";
              break;
            case 0x08:
              fileTypeString = "trace";
              break;
            case 0x0a:
              fileTypeString = "data";
              break;
            case 0x0c:
              fileTypeString = "asmb_sym";
              break;
            case 0x0d:
              fileTypeString = "absolute";
              break;
            case 0x0e:
              fileTypeString = "comp_sym";
              break;
            default:
              break;
          }
